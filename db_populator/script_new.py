...
import re
import os
depts = [{"id":3,"name":"Biological Sciences"},{"id":2,"name":"Computational Biology"},{"id":15,"name":"Computer Science"},{"id":76,"name":"English"},{"id":5,"name":"Human-Computer Interaction"},{"id":11,"name":"Language Technologies Institute"},{"id":10,"name":"Machine Learning"},{"id":85,"name":"Psychology"},{"id":16,"name":"Robotics"},{"id":36,"name":"Statistics"},{"id":21,"name":"Mathematical Sciences"}]
def pr(data):
